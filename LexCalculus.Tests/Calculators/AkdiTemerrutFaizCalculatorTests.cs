...
public class AkdiTemerrutFaizCalculatorTests
{
    private static (AkdiTemerrutFaizCalculator calc, LexCalculus.Infrastructure.Data.ApplicationDbContext ctx) Build()
    {
